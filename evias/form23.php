        ...
        <form action="./send_form23.php" method="post" class="list-group">
            ...
            <table border="1" class="table table-sm materiais" >
                ...
                <tr>
                    ...
                    <td><input type="date" name="fdata_coleta[]" id="materiais"             value="<?php echo $cabecalho['DATA_COLETA'] -> format('d/m/y');?>"></td>
                ...
                <?php while ($result2 = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)):?>
                <tr>
                    <td class="cabecalho"><?php echo $cont++;?></td>
                    <td><input type="text" name="fmaterial[]" id="materiais"                value="<?php echo $result2['MATERIAL'];?>"></td>
                    <td><input type="date" name="fdata_coleta[]" id="materiais"             value="<?php echo $result2['DATA_COLETA'] -> format('d/m/y');?>"></td>
                    <td><input type="text" name="flocal_amostragem[]" id="materiais"        value="<?php echo $result2['LOCAL_AMOSTRAGEM'];?>"></td>
                    <td><input type="number" name="fvolume[]" id="materiais"                value="<?php echo $result2['VOLUME'];?>"></td>
                    <td><input type="text" name="fpeso[]" id="materiais"                    value="<?php echo $result2['PESO'];?>"></td>
                    <td><input type="text" name="ensaiar_amostra[]" id="materiais"          value="<?php echo $result2['AMOSTRA_PODE_SER_ENSAIADA'];?>"></td>
                    <td><input type="text" name="quantidade_suficiente[]" id="materiais"    value="<?php echo $result2['QUANTIDADE_SUFICIENTE'];?>"></td>
                </tr>
                <?php endwhile ?>
            </table>
