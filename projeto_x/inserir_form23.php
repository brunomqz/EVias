        ...
        <form action="./send_form23.php" method="post" class="list-group">
            ...
            <table border="1" class="table table-sm materiais" >
                ...
                <tr>
                    ...
                    <td><input type="text" name="" id="materiais" value="<?php echo $cabecalho['MATERIAL'];?>"></td>
                    <td><input type="text" name="fdata_coleta" id="materiais" value="<?php echo $cabecalho['DATA_COLETA'] -> format('d/m/y') ?>"></td>
                    <td><input type="text" name="flocal_amostragem" id="materiais" value="<?php echo $cabecalho['LOCAL_AMOSTRAGEM']; ?>"></td>
                    <td><input type="number" name="" id="materiais" value="<?php echo $cabecalho['VOLUME']; ?>"></td>
                ...
                <tr>
                    <td class="cabecalho" ><?php echo $cont++; ?></td>
                    <td><input type="text" name="" id="materiais" value="<?php echo $linha['MATERIAL'];?>"></td>
                    <td><input type="text" name="fdata_coleta" id="materiais" value="<?php echo $linha['DATA_COLETA'] -> format('d/m/y') ;?>"></td>
                    <td><input type="text" name="flocal_amostragem" id="materiais" value="<?php echo $linha['LOCAL_AMOSTRAGEM']; ?>"></td>
                    <td><input type="number" name="" id="materiais" value="<?php echo $linha['VOLUME']; ?>"></td>
                    <td><input type="text" name="fpeso" id="materiais" value="<?php echo $linha['PESO']; ?>"></td>
            ...
            <input type="text" name="fobservacao" class="registro" value="<?php echo $linha['OBSERVACAO'] ?>" >
