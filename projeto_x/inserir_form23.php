...
$linha = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC);
        ...
        <form action="./send_form23.php" method="post" class="list-group">
            ...
            <div class="row col-lg-12 col-md-12 col-sm-12" >
                <div class="form-group col ">
                    ...
                    <br>
                    <input type="text" class="registro" name="fdata" id="fdata" value="<?php echo $linha['DATA_RECEBE'] -> format('d/m/y'); ?>" readonly >
                </div>
            ...
            <div class="row col-lg-12 col-md-12 col-sm-12" >
                ...
                <div class="form-group col ">
                    ...
                    <br>
                    <input type="text" class="registro" name="fprotocolo" id="fprotocolo" value="<?php echo $linha['PROTOCOLO_REC']; ?>" readonly>
                </div>
            </div>
            ...
            <table border="1" class="table table-sm materiais" >
                ...
                <tr>
                    ...
                    <td><input type="text" name="ensaiar_amostra" id="materiais"></td>
                    <td><input type="text" name="quantidade_suficiente" id="materiais"></td>
                </tr>
                <?php endwhile; ?>
            </table>
