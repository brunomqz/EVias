        ...
        <form action="./send_form23.php" method="post" class="list-group">
            ...
            <table border="1" class="table table-sm materiais" >
                ...
                <tr>
                    ...
                    <input type="hidden" name="id_amostra" id="id_amostra" value="<?php $cabecalho['ID_AMOSTRA'];?>">
                </tr>

                <?php while ($linha = sqlsrv_fetch_array($result, SQLSRV_FETCH_ASSOC)): ?>
                <tr>
                    <td class="cabecalho"><?php echo $cont++;?></td>
                    <td><input type="text" name="fmaterial" id="materiais"                  value="<?php echo $linha['MATERIAL'];?>"></td>
                    <td><input type="date" name="fdata_coleta" id="materiais"               value="<?php echo isset($cabecalho['DATA_COLETA']) ? $cabecalho['DATA_COLETA'] -> format('Y-m-d') : '';?>"></td>
                    <td><input type="text" name="flocal_amostragem" id="materiais"          value="<?php echo $linha['LOCAL_AMOSTRAGEM'];?>"></td>
                    <td><input type="number" name="fvolume" id="materiais"                  value="<?php echo $linha['VOLUME']; ?>"></td>
